...
export const sidebarData = [
    {
        name: "Test Portal",
        path: "/Auth/Login",         // These Links will be chaged
        icon: <AssignmentSharpIcon />
    },
    {
        name: "Assignment Portal",
        path: "/Auth/SignUp",        // These Links will be changed
        icon: <DriveFolderUploadSharpIcon />
    },
    {
        name: "Report Portal",
        path: "/Auth/SignUpDone",    // These Links will be changed
...
const TopNavigation = () => {
    ...
    return (
        <Stack sx={{ width: "100%", padding: "20px" }} spacing={2}>
            <Stack direction="row" spacing={2} sx={{ justifyContent: "center", marginBottom: "10px" }}>
