...
import { Button, Checkbox, Box, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, FormControlLabel, FormLabel, Radio, RadioGroup, Stack, TextField } from '@mui/material';
...
export type AddQuestionPropType = {
    open: boolean, setOpen: (value: any) => void, testQuestions: any, setTestQuestions: (value: any) => void,
    ...
    return (
        <Dialog open={open} onClose={handleClose} sx={{ padding: "20px 30px" }} maxWidth="md" fullWidth={true}>
            ...
            <DialogContent sx={{ padding: "20px 30px" }}>
                ...
                <Box sx={{ mt: 3 }}>
                    ...
                    <Stack direction="row" spacing={2} component="form" onSubmit={handleAddChoice} sx={{ mt: 3 }}>
                        ...
                        <Button color="error" type="submit" variant='contained'>Add</Button>
                    </Stack>
                    {
                        choices.length > 0 &&
                        <Box sx={{ mt: 3 }}>
            ...
            <DialogActions>
                ...
                <Button onClick={handleAdd} color="error">Add</Button>
            </DialogActions>
        </Dialog>
    )
}
